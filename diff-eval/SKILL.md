...
**Classification method**: For each file, apply two checks in order:
1. **Path-based check**: Match against known auto-generated file name, extension, and directory patterns (fast, no file content needed)
2. **Content-based check**: If not matched by path, **read the first 10 lines** of the file and scan for auto-generated markers (critical — many generated files have normal-looking names but contain header comments)

#### 2a. Path-Based Patterns (auto-generated)

**Lock files**:
`package-lock.json`, `yarn.lock`, `pnpm-lock.yaml`, `Pipfile.lock`, `poetry.lock`, `Gemfile.lock`, `composer.lock`, `Cargo.lock`, `go.sum`, `Gopkg.lock`, `glide.lock`, `bun.lockb`, `bun.lock`, `deno.lock`, `flake.lock`, `MODULE.bazel.lock`, `.terraform.lock.hcl`, `Package.resolved`, `pdm.lock`, `uv.lock`, `pixi.lock`, `esy.lock`, `npm-shrinkwrap.json`, `.pnp.cjs`, `.pnp.loader.mjs`

**Build outputs & compiled artifacts**:
`dist/`, `build/`, `.next/`, `__pycache__/`, `htmlcov/`, `*.pyc`, `*.min.js`, `*.min.css`, `*.bundle.js`, `*.map` (source maps)

**Generated code by extension**:
`*.pb.go`, `*_pb2.py`, `*.pb.h`, `*.pb.cc`, `*.pb.js`, `*.grpc.go` (protobuf/gRPC), `*.designer.cs`, `*.designer.vb`, `*.g.cs`, `*.g.i.cs`, `*.generated.cs`, `*.feature.cs` (.NET generated), `*.zep.c`, `*.zep.h`, `*.zep.php` (Zephir), `*_tlb.pas` (Delphi)

**Build tool wrappers**:
`gradlew`, `gradlew.bat`, `mvnw`, `mvnw.cmd`

**IDE/tool artifacts**:
`.idea/`, `.vscode/settings.json`, `.DS_Store`, `Pods/`, `Carthage/Build/`

**Other generated directories**:
`node_modules/`, `vendor/` (Go modules), `__generated__/` (GraphQL Relay), `__snapshots__/`, `.sqlx/`
...
#### 2b. Content-Based Detection (check first 10 lines of each file)

**This is the critical step.** Many auto-generated files have normal-looking paths but contain header markers. For every file not already classified by path, read the first 10 lines and look for these patterns (case-insensitive):

**Universal markers** (any language):
- `@generated` — Facebook/Phabricator convention, widely adopted
- `DO NOT EDIT` / `DO NOT MODIFY` / `do not edit by hand`
- `auto-generated` / `autogenerated` / `auto generated`
- `This file is generated` / `This file was generated`
- `automatically generated` / `machine generated`
- `Generated by` (followed by tool name)
- `<auto-generated>` / `<autogenerated />` (.NET XML comment)
- `Code generated` (Go convention: `// Code generated .* DO NOT EDIT\.$`)

**Tool-specific markers** (match any of these strings):
- `Generated by the protocol buffer compiler` (protobuf)
- `Autogenerated by Thrift Compiler` (Thrift)
- `GENERATED CODE -- DO NOT EDIT!` (JS protobuf)
- `Code generated by protoc-gen-ts_proto` (TS protobuf)
- `Generated by the gRPC` (gRPC)
- `GENERATED CODE - DO NOT MODIFY` (Dart codegen)
- `Generated by CoffeeScript` / `Generated by Cython` / `Generated by Haxe`
- `This file is automatically generated by Racc`
- `The following code was generated by JFlex`
- `This is a generated file. Not intended for manual editing.` (GrammarKit)
- `% Generated by roxygen2: do not edit by hand` (R)
- `parser generated by jison` / `generated by jison-lex`
- `This file is generated by jOOQ`
- `DO NOT EDIT THIS FILE - it is machine generated` (JNI)
- `Generated by PEG.js` (parser generators)
- `generated by Xtest` (ANTLR)

**Heuristic checks** (apply to files that look suspicious):
- Average line length > 110 characters → likely minified
- Last 2 lines contain `//# sourceMappingURL=` or `/*# sourceURL=` → source maps/bundles
